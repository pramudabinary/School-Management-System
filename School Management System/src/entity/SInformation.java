...
public class SInformation implements SuperEntity {
    private String name;
    ...
    public SInformation(String name, String address, String zone, String province, String district, String name_principal, String principal_con) {
        this.name = name;
